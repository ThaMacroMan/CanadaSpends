...
export default function Page(props) {
  return (
    <main className="bg-linen-100 text-charcoal-950">{props.children}</main>
  );
}
```
...
<div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 10px; margin-bottom: 20px;">
    <div style="width: 80px; height: 80px; background-color: #fcf4f4; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #333;">auburn-50<br/>#fcf4f4</div>
    <div style="width: 80px; height: 80px; background-color: #fae6e6; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #333;">auburn-100<br/>#fae6e6</div>
    <div style="width: 80px; height: 80px; background-color: #f7d1d1; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #333;">auburn-200<br/>#f7d1d1</div>
    <div style="width: 80px; height: 80px; background-color: #f1b0b0; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #333;">auburn-300<br/>#f1b0b0</div>
    <div style="width: 80px; height: 80px; background-color: #e68383; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #333;">auburn-400<br/>#e68383</div>
    <div style="width: 80px; height: 80px; background-color: #d85b5b; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #eee;">auburn-500<br/>#d85b5b</div>
    <div style="width: 80px; height: 80px; background-color: #c43e3e; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #eee;">auburn-600<br/>#c43e3e</div>
    <div style="width: 80px; height: 80px; background-color: #a43131; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #eee;">auburn-700<br/>#a43131</div>
    <div style="width: 80px; height: 80px; background-color: #932f2f; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #eee;">auburn-800<br/>#932f2f</div>
    <div style="width: 80px; height: 80px; background-color: #722a2a; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #eee;">auburn-900<br/>#722a2a</div>
    <div style="width: 80px; height: 80px; background-color: #3d1212; border: 1px solid #ccc; display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 0.7em; text-align: center; color: #eee;">auburn-950<br/>#3d1212</div>
</div>

Build Canada's main braind makes use of `*-auburn-800` / `#932f2f` as it's primary colour.
Builders can pull other values from this list to ensure their designs align with the BuildCanada brand.
...
export default function Page(props) {
  return (
    <main className="bg-linen-100 text-charcoal-950">
      <button className="bg-auburn-800 text-linen-100 hover:bg-auburn-600">
        Join Build Canada
      </button>
      {props.children}
    </main>
